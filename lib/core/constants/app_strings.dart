class AppStrings {
  ...
  // Auth
  static const authWelcomeBack = 'auth.welcomeBack';
  static const authLoginSubtitle = 'auth.loginSubtitle';
  static const authEmailLabel = 'auth.emailLabel';
  static const authEmailHint = 'auth.emailHint';
  static const authPasswordLabel = 'auth.passwordLabel';
  ...
  static const failureNetwork = 'failures.network';
  static const failureValidation = 'failures.validation';
  static const failureAuthentication = 'failures.authentication';
  static const failureAuthorization = 'failures.authorization';
  static const failureUnexpected = 'failures.unexpected';
  ...
  static const navRequests = 'nav.requests';
  ...
  static const roleFreelancer = 'role.freelancer';
  static const roleSwitchedToClient = 'role.switchedToClient';
  static const roleSwitchedToFreelancer = 'role.switchedToFreelancer';

  // Onboarding
  static const onboardingWelcome = 'onboarding.welcomeTitle';
  ...
  static const bookingRequestsActive = 'booking.requests.active';
  static const bookingRequestsPending = 'booking.requests.pending';
  ...
  static const chatPhotographerPrefix = 'chat.list.photographerPrefix';
  static const chatClientPrefix = 'chat.list.clientPrefix';
  static const chatPlaceholderMessage = 'chat.list.placeholderMessage';
  static const chatTimePlaceholder = 'chat.list.timePlaceholder';
  static const chatRoomTitle = 'chat.room.title';
  ...
  static const freelancerGigSampleTitle = 'freelancer.gigs.sampleTitle';
  static const freelancerOrdersTitle = 'freelancer.orders.title';
  static const freelancerOrderNew = 'freelancer.orders.newStatus';

  // Profile
  static const profileTitle = 'profile.title';
  static const profileTransactions = 'profile.transactions';
